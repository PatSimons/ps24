...
(() => {
  ...
  window.Webflow.push(() => {
    ...
    if (isDesktop) {
      let startMouseFollower2 = function() {
        if (!trailWrapper)
          return;
      ...
      }, stopMouseFollower2 = function() {
        gsapWithCSS.to(trailWrapper, { opacity: 0, delay: 0, duration: 0.25 });
      };
      var startMouseFollower = startMouseFollower2, stopMouseFollower = stopMouseFollower2;
...
gsap/InertiaPlugin.js:
  ...
  *)
*/
//# sourceMappingURL=freebranding.js.map

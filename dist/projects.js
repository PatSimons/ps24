      ...
      (context3) => {
        ...
        if (modal) {
          ...
          if (openModalBtns.length > 0) {
            ...
            if (contactForm) {
              let resetForm2 = function(form) {
                form.reset();
                contactForm.querySelectorAll(".is-checked, .w--redirected-checked").forEach((element) => {
              ...
              var resetForm = resetForm2;
              contactForm.addEventListener("submit", function(event) {
                event.preventDefault();
                setTimeout(function() {
                  tl_openModal.timeScale(2).reverse();
                  bodyOverflowHidden();
                  resetForm2(contactForm);
                }, 2e3);
              });
            }
          }
          ...
          cmsItems.forEach((item) => {
            ...
            cmsFilterItemsArray.forEach((el) => {
              ...
              if (filtersArray.includes(linkFilter) || linkFilter === "all-projects") {
                ...
                gsapWithCSS.set(item, { autoAlpha: 0, y: "5rem" });
                gsapWithCSS.to(item, { autoAlpha: 1, y: 0, ease: "power3.out", duration: 1 });
              } else {
